...
namespace PanelinhasDoGallo.Migrations
{
    ...
    [Migration("20240930151053_criar-banco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "681cd3bd-04bc-4dda-a73b-ee5a625993e8",
                            Email = "admin@panelinhasdogalo.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@PANELINHASDOGALO.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEF1S0muqRtC2WX+n1LaakR4VEu+zPrX6vX/8U1Z3mvImCsHo1KKMDo5V5ia5U62HOw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2dd24f48-f5f6-4395-883f-2f301af17bdc",
                        ...
                        new
                        {
                            Id = "0b44ca04-f6b0-4a8f-a953-1f2330d30894",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6478aea2-41e8-4a37-b2d5-4511f568c001",
                            Email = "Nikolau@panelinhasdogalo.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "NIKOLAU@PANELINHASDOGALO.COM",
                            NormalizedUserName = "NIKOLAU",
                            PasswordHash = "AQAAAAIAAYagAAAAEDmtXrIi9RdaEL931YFnbBxX5dsaBGd7S5B1EQ7ybgFaR0rWCdRK7MRIWLlo0anaXQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5feaf281-3c42-4a4e-9022-7a76b4185f20",
                            TwoFactorEnabled = false,
                            UserName = "Nikolau"
                        });
                });
            ...
            modelBuilder.Entity("PanelinhasDoGallo.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PanelinhasDoGallo.Models.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PanelinhasDoGallo.Models.Comentario", b =>
                {
                    b.HasOne("PanelinhasDoGallo.Models.Receita", "Receita")
                        .WithMany()
                        .HasForeignKey("ReceitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PanelinhasDoGallo.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("PanelinhasDoGallo.Models.Receita", b =>
                {
                    b.HasOne("PanelinhasDoGallo.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("PanelinhasDoGallo.Models.ReceitaIngrediente", b =>
                {
                    b.HasOne("PanelinhasDoGallo.Models.Ingrediente", "Ingrediente")
                        .WithMany("Receitas")
