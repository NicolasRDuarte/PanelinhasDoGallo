...
namespace PanelinhasDoGallo.Migrations
{
    /// <inheritdoc />
    public partial class criarbanco : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReiceitaIngrediente", x => new { x.ReceitaId, x.IngredienteId });
                    table.ForeignKey(
                        name: "FK_ReiceitaIngrediente_Ingrediente_IngredienteId",
                        column: x => x.IngredienteId,
                        principalTable: "Ingrediente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReiceitaIngrediente_Receita_ReceitaId",
                        column: x => x.ReceitaId,
                        principalTable: "Receita",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0b44ca04-f6b0-4a8f-a953-1f2330d30894", 0, "0d5eee03-5682-4c2c-8bec-38d3da5d2aff", "Nikolau@panelinhasdogalo.com", true, false, null, "NIKOLAU@PANELINHASDOGALO.COM", "NIKOLAU", "AQAAAAIAAYagAAAAEKx13BB06Z8EQTpSexIvv4ON4JGB+35c2k5O98+Bom58+/OZbPp5Lpwh4cTf3Dopkg==", null, false, "985b9b29-eee3-4db5-a6dd-59eeff75ce49", false, "Nikolau" },
                    { "ddf093a6-6cb5-4ff7-9a64-83da34aee005", 0, "c0f8cb56-a568-4c89-a56b-bfc0169aeca2", "admin@panelinhasdogalo.com", true, false, null, "ADMIN@PANELINHASDOGALO.COM", "ADMIN", "AQAAAAIAAYagAAAAEIGEIb0UX2+m56RzH1wDh07d1osuGP2Kyiq7lZd5qmjcVpvhMDclAoV+Kj6AO2Idvg==", null, false, "0b207868-3b3b-4468-8fe8-086935ae795d", false, "Admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0b44ca04-f6b0-4a8f-a953-1f2330d30894", new DateTime(2007, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "/img/usuarios/avatar.png", "Nikolau" },
                    { "ddf093a6-6cb5-4ff7-9a64-83da34aee005", new DateTime(1981, 8, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "/img/usuarios/avatar.png", "José Antonio Gallo Junior" }
                });

            migrationBuilder.InsertData(
                table: "ReiceitaIngrediente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReiceitaIngrediente_IngredienteId",
                table: "ReiceitaIngrediente",
